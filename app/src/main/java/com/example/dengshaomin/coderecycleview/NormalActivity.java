...
public class NormalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (commonAdapter == null) {
            commonAdapter = new CommonAdapter<String>(NormalActivity.this, R.layout.item_view, datas) {
                @Override
        ...
        coderecycleView.addHeaderView(createHeaderView("head"));
        coderecycleView.addFootView(createHeaderView("foot"), true);
        coderecycleView.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                Toast.makeText(NormalActivity.this, position + "", Toast.LENGTH_SHORT).show();
            }
    ...
    public View createHeaderView(String s) {
